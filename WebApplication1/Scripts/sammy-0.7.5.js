...
(function(factory){
  ...
  // using different methods depending on what is avaitd in the current browser. In
...
$.extend(Sammy.DefaultLocationProxy.prototype , {
  ...
  // This within these callbacks the special methods of `EventContext` are avaitd.
  //
  // ### Example
  //
  //       $.sammy(function() {
